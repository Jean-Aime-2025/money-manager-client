            ...
            <div className='relative p-4 w-full max-w-2xl max-h-[90vh]'>
                <div className='relative bg-white rounded-xl shadow-2xl border border-gray-100'>
                    <div className='flex items-center justify-between p-5 md:p-6 border-b border-gray-100 rounded-t-xl'>
                        ...
                        onClick={onClose}
                        type='button'
                        className='text-gray-500 bg-gray-50 hover:bg-gray-100 hover:text-gray-700 rounded-lg text-sm w-9 h-9 flex items-center justify-center border border-gray-200/50 transition-colors duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2'>
                            <X className='w-4 h-4'/>
                        </button>
                    </div>
